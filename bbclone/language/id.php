 ...
 * 
 * SVN FILE $Id: id.php 241 2014-02-06 18:39:59Z joku $
 *  
...
// Language: Indonesian (Bahasa Indonésia)
...
// Global translation
"global_titlebar"=> "statistik untuk %SERVER dihasilkan pada %DATE",
...
"dstat_whois_information" => "Carilah informasi tentang IP Adress ini",
...
"tstat_full_su" => "Minggu",
"tstat_full_mo" => "Senin",
"tstat_full_tu" => "Selasa",
"tstat_full_we" => "Rabu",
"tstat_full_th" => "Kamis",
"tstat_full_fr" => "Jumat",
"tstat_full_sa" => "Sabtu",
...
"tstat_full_jun" => "Juni",
"tstat_full_jul" => "Juli",
"tstat_full_aug" => "Agustus",
"tstat_full_sep" => "September",
"tstat_full_oct" => "Oktober",
"tstat_full_nov" => "November",
"tstat_full_dec" => "Desember",

"tstat_last_day" => "Hari terakhir",
"tstat_last_week" => "Minggu terakhir",
"tstat_last_month" => "Bulan terakhir",
"tstat_last_year" => "Tahun terakhir",
"tstat_average" => "rata-rata",

// Loadtime notice
"generated" => "Halaman yang dihasilkan dalam ",
"seconds" => " second",

// Configuration page words and sentences
"config_variable_name" => "Nama Variabel ini",
"config_variable_value" => "Nilai Variabel ini",
"config_explanations" => "Penjelasan",
